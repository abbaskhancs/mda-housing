...
async function main() {
  ...
  const stages = [
    ...
    { code: 'SENT_TO_WATER', name: 'Sent to Water', sortOrder: 8 },
    { code: 'WATER_PENDING', name: 'Water Pending', sortOrder: 9 },
    { code: 'WATER_CLEAR', name: 'Water Clear', sortOrder: 10 },
    { code: 'ON_HOLD_WATER', name: 'On Hold - Water', sortOrder: 11 },
    { code: 'SENT_TO_ACCOUNTS', name: 'Sent to Accounts', sortOrder: 12 },
    { code: 'ON_HOLD_BCA', name: 'On Hold - BCA', sortOrder: 13 },
    { code: 'ON_HOLD_HOUSING', name: 'On Hold - Housing', sortOrder: 14 },
    { code: 'ACCOUNTS_PENDING', name: 'Accounts Pending', sortOrder: 15 },
    { code: 'AWAITING_PAYMENT', name: 'Awaiting Payment', sortOrder: 16 },
    { code: 'ON_HOLD_ACCOUNTS', name: 'On Hold - Accounts', sortOrder: 17 },
    { code: 'ACCOUNTS_CLEAR', name: 'Accounts Clear', sortOrder: 18 },
    { code: 'OWO_REVIEW_ACCOUNTS', name: 'OWO Review - Accounts', sortOrder: 19 },
    { code: 'PAYMENT_PENDING', name: 'Payment Pending', sortOrder: 20 },
    { code: 'READY_FOR_APPROVAL', name: 'Ready for Approval', sortOrder: 21 },
    { code: 'APPROVED', name: 'Approved', sortOrder: 22 },
    { code: 'POST_ENTRIES', name: 'Post-Entries', sortOrder: 23 },
    { code: 'REJECTED', name: 'Rejected', sortOrder: 24 },
    { code: 'CLOSED', name: 'Closed', sortOrder: 25 },
    { code: 'COMPLETED', name: 'Completed', sortOrder: 26 },
  ]
  ...
  const transitions = [
    ...
    { from: 'OWO_REVIEW_BCA_HOUSING', to: 'SENT_TO_WATER', guard: 'GUARD_WATER_REQUIRED' },
    { from: 'OWO_REVIEW_BCA_HOUSING', to: 'SENT_TO_ACCOUNTS', guard: 'GUARD_OWO_REVIEW_COMPLETE' },
    { from: 'SENT_TO_WATER', to: 'WATER_PENDING', guard: 'GUARD_SENT_TO_WATER' },
    { from: 'WATER_PENDING', to: 'WATER_CLEAR', guard: 'GUARD_WATER_CLEAR' },
    { from: 'WATER_PENDING', to: 'ON_HOLD_WATER', guard: 'GUARD_WATER_OBJECTION' },
    { from: 'WATER_CLEAR', to: 'SENT_TO_ACCOUNTS', guard: 'GUARD_WATER_COMPLETE' },
    { from: 'ON_HOLD_WATER', to: 'WATER_PENDING', guard: 'GUARD_WATER_RESOLVED' },
    { from: 'ON_HOLD_WATER', to: 'UNDER_SCRUTINY', guard: 'GUARD_FIX_AND_RESUBMIT_WATER' },
    ...
    { from: 'ON_HOLD_BCA', to: 'UNDER_SCRUTINY', guard: 'GUARD_FIX_AND_RESUBMIT_BCA' },
    { from: 'ON_HOLD_BCA', to: 'SENT_TO_BCA_HOUSING', guard: 'GUARD_RESEND_TO_BCA_HOUSING' },
    ...
    { from: 'ON_HOLD_ACCOUNTS', to: 'UNDER_SCRUTINY', guard: 'GUARD_FIX_AND_RESUBMIT_ACCOUNTS' },
